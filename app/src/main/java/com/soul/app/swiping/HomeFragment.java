...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.activity_home_finding_people, container, false);
        initUi(view);
    ...
    public void initUi(View view) {
        if (Utility.isGpsOn(getActivity())) {
            Log.d("GPS", "ON");
        } else {
        ...
        mFindingPotentialMatch = (TextView) view.findViewById(R.id.finding_potential_match_tv);
        Animation bottomUpText = AnimationUtils.loadAnimation(getActivity(), R.anim.bottom_up_text);
        mFindingPotentialMatch.setAnimation(bottomUpText);
        img_undo_nocard = (ImageView) view.findViewById(R.id.img_undo_nocard);
        mLeftArrowImg = (ImageView) view.findViewById(R.id.left_arrow_img);
        mRightArrowImg = (ImageView) view.findViewById(R.id.right_arrow_img);
        frameLayoutHomeHeader = (FrameLayout) view.findViewById(R.id.home_header_frame_layout);
        findingPeopleHome = (RelativeLayout) view.findViewById(R.id.finding_people_home_rl);
        findingPeopleHome.setVisibility(View.VISIBLE);
        findingPeopleAnimation = (ImageView) view.findViewById(R.id.finding_people_animation_iv);

        GlideDrawableImageViewTarget imageViewTarget = new GlideDrawableImageViewTarget(findingPeopleAnimation);
        Glide.with(getActivity()).load(R.raw.soul_logo).into(imageViewTarget);
        // frameUp = (RelativeLayout) findViewById(R.id.image_ll);
        frameUp = (FrameLayout) view.findViewById(R.id.image_ll);
        flingContainer = (SwipeFlingAdapterView) view.findViewById(R.id.frame_sfav);
//        frameUp = (FrameLayout) findViewById(R.id.image_ll);
        frameB = (FrameLayout) view.findViewById(R.id.no_image);
        ...
        img_undo_nocard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mDataUndo.size() != 0) {
                    ...
                    cardSwAdapter = new CardSwipeAdapter(mData, getActivity());
        ...
        profileIcon = (ImageView) view.findViewById(R.id.hh_profile_icon);
        txt_name = (TextView) view.findViewById(R.id.txt_name);
        txt_designation = (TextView) view.findViewById(R.id.txt_designation);
        likeBottom = (ImageView) view.findViewById(R.id.like_bottom);
        sDislikeBottom = (ImageView) view.findViewById(R.id.dislike_bottom);
...
/*
        ...
        profileIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ApplicationController.getApplicationInstance().isNetworkConnected()) {
                    Intent intentMyProfile = new Intent(getActivity(), MyProfileActivity.class);
        ...
        chatIcon = (ImageView) view.findViewById(R.id.hh_chat_icon);
       ...
       /* FrameLayout mProfilell = (FrameLayout) findViewById(R.id.profile_lin_layout);
        if (mProfilell != null) {
            mProfilell.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        if (ApplicationController.getApplicationInstance().isNetworkConnected()) {
                            Intent intent = new Intent(getActivity(), com.soul.app.activity.MatchedProfileActivity.class);
        ...
        RelativeLayout inviteFrndBtn = (RelativeLayout) view.findViewById(R.id.invite_frnd_btn);
...
//                        if (imageCount < 3) {
//                            Glide.with(getActivity()).load(mLMap.get(pos + 1).get(imageCount)).into(cardSwAdapter.imgView);
//                            ++imageCount;
//                        }
                ...
                if (userList.size() > 0) {
                   ...
                   /* if (!TextUtils.isEmpty(designation)) {
                    ...
                    try {
                        ...
                        Glide.with(getActivity()).load(userList.get(0).getProfile_pic()).into(imageView);
            ...
            call.enqueue(new Callback<LikeDislikeRes>() {
                ...
                public void onResponse(Call<LikeDislikeRes> call, Response<LikeDislikeRes> response) {
                    ...
                    if (response.isSuccessful()) {
                        if (response.body() != null) {
                            isLike = false;
                            //DialogUtils.showToast(getActivity(),response.body().getMsg());
                        }
                    }
                }
            ...
            public void onClick(View v) {
                ...
                if (mUserImgList.size() > rightCount) {
                    ...
                    try {
                        ...
                        // Utility.glide(getActivity(),imageView,0,mUserImgList.get(rightCount));
                        ...
                        // Utility.glide(getActivity(), imageView, 0, url);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Constants.LIKEDISLIKE) {
            if (mData != null) {
                ...
                setProfileInfo(mData);
                try {
                    Glide.with(getActivity()).load(mData.get(0).getProfile_pic()).into(imageView);
                } catch (Exception e) {
                    e.printStackTrace();
                }
                cardSwAdapter.notifyDataSetChanged();
